 ...
 *
 */
public class InheritaceContext 
{
    ...
    {/*
         ...
         */
         ...
         HelloWorldInheritance objA = (HelloWorldInheritance) context.getBean("helloWorld");
         objA.getMessage1();
         objA.getMessage2();

         HelloWorldIndia objB = (HelloWorldIndia) context.getBean("helloIndia");
         objB.getMessage1();
         objB.getMessage2();
         objB.getMessage3();
    }
